...
"""
XGBoost MIMO 时序预测算子单元测试

对应源文件：
- forecasting/xgboost_mimo.py: XGBoostMIMOForecaster, XGBoostMIMOForecasterConfig
...
class TestXGBoostMIMOForecaster:
    ...
    def test_fit_learns_model(self, train_data, minimal_config):
        ...
        forecaster = XGBoostMIMOForecaster(config=minimal_config)
        y = train_data[:, [-1]]

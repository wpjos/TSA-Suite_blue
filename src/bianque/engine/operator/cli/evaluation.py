...
调用方式::
    ...
    python -m bianque.engine.operator.cli evaluation help
    python -m bianque.engine.operator.cli evaluation help binary_classification_metric
    python -m bianque.engine.operator.cli evaluation run --input predictions.csv --output result.json --config eval_pipeline.yaml
...
from bianque.engine.operator.cli.io import load_data, save_json
...
def create_registry() -> OperatorRegistry:
    ...
    扫描 ``bianque.engine.operator.evaluation`` 包，
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog='python -m bianque.engine.operator.cli evaluation',

...
示例用法::
    ...
    # 直接评分
    scorer = ZScoreScorer(threshold=3.0)
...
from bianque.engine.operator.detection.threshold_decider import (
    ThresholdDecider,
)
...
class ZScoreDetector(UnsupervisedNumericOperatorMixin[None],
    ...
    def __init__(self, *, oid: str | None = None, config: ZScoreDetectorConfig | None = None, **kwargs):
        ...
        self._decider = ThresholdDecider(threshold=self.config.threshold)
